...
start_date = response.json()["data"]["measurements_metadata"]["start_datetime"]
end_date = response.json()["data"]["measurements_metadata"]["end_datetime"]
params = {
...
print("-"*79)
print(f"Challenge observed data:")
print(dataset)
