      ...
      <Dialog open={sidebarOpen} onClose={setSidebarOpen} className="relative z-50 lg:hidden">
        ...
        <div className="fixed inset-0 flex">
          <DialogPanel className="relative mr-16 flex w-full max-w-xs flex-1 bg-white">
            ...
            <div
              className="flex flex-col gap-y-5 overflow-y-auto p-6 pb-4 bg-gradient-to-b from-orange-100 via-white to-orange-200">
              <div className="flex h-16 items-center">
                <img src={logo} alt="Your Company" className="h-16 w-auto sm:h-20"/>
              </div>
