...
from system.restore import restore_tables_from_csv, restore_full_database
...
if __name__ == '__main__':
    ...
    # ---- Restore Database:
    restore_database_parser = restore_subparsers.add_parser("database", help="Restore the entire database")
    restore_database_parser.add_argument('--file_name', action="store", help="file output by the pg_dump command", required=True)
    ...
    if args.group == "backup":
        ...
        elif args.restore_option == "database":
            print("Restoring database")
            restore_full_database(args.file_name)
