...
urlpatterns = [
    # Password reset views
        re_path('password-reset/confirm/?$', PasswordResetView.as_view(), name='password-reset-confirm'),
    re_path('password-reset/?$', PasswordResetRequestView.as_view(), name='password-reset-request'),
